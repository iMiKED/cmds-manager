...
- современная компактная таблица и toolbar в стиле Fluent Compact с системной, светлой и тёмной темами без внешних UI-зависимостей;
...
```text
artifacts\CmdsManager-portable-0.6.0-win-x64.zip
```
