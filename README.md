...
- вкладки в стиле Windows Terminal: скруглённый верх, фигурные нижние плечи, активная вкладка без рамки сливается с консолью, предусмотрены hover-состояние, статусная точка и компактный крестик;
...
```text
artifacts\CmdsManager-portable-0.4.1-win-x64.zip
```
