    ...
    internal static class LocalizationDefaults
    {
        ...
        private static Dictionary<string, string> BuildRussian()
        {
            return Dictionary(new[]
            {
                ...
                Pair("Script.Interpreter.VbsWindow", "VBS — wscript.exe"), Pair("Script.Encoding.Auto", "Авто (UTF-8/OEM Windows)"),
        ...
        private static Dictionary<string, string> BuildEnglish()
        {
            return Dictionary(new[]
            {
                ...
                Pair("Console.StopFailed", "Could not stop the script from its tab."), Pair("Script.Title.Add", "Add script"), Pair("Script.Title.Edit", "Edit script"),
                ...
                Pair("Script.Interpreter.VbsConsole", "VBS — cscript.exe"), Pair("Script.Interpreter.VbsWindow", "VBS — wscript.exe"), Pair("Script.Encoding.Auto", "Auto (UTF-8/Windows OEM)"),
